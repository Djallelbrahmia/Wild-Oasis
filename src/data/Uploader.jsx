...
async function createBookings() {
  ...
  const finalBookings = bookings.map((booking) => {
    ...
    const numOfNight = subtractDates(booking.endDate, booking.startDate);
    const cabinPrice = numOfNight * (cabin.regularPrice - cabin.discount);
    const extraPrice = booking.hasBreakfast
      ? numOfNight * 15 * booking.numGuests
